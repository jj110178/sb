...
package com.liferay.live.sb.demo.service.messaging;

import com.liferay.live.sb.demo.service.ClpSerializer;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if ("undeploy".equals(command) &&
			...
			CourseCatalogLocalServiceUtil.clearService();

			CourseStudentLocalServiceUtil.clearService();

			InstructorLocalServiceUtil.clearService();

			StudentLocalServiceUtil.clearService();

			StudentGPALocalServiceUtil.clearService();
		}
	}
}
